    ...
    return (
        <div className="flex flex-col h-full relative">
            ...
            <form className="chat_input" onSubmit={handleSubmit}>
                <input className="input_field" type="text" placeholder="Type a message..."
                ...
                <button className="material-icons p-3" type="submit" disabled={(text || media.length > 0) ? false : true}>
                    near_me
                </button>
            </form>
        </div>
